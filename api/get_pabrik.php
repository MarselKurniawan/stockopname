...
$stmt = $conn->prepare("SELECT pabrik.*, toko.nama_toko, produk.nama_produk FROM pabrik JOIN produk ON pabrik.produk_id = produk.id JOIN toko ON pabrik.toko_id = toko.id;");
if (!$stmt) {
