...
<head>
  ...
  <link rel="stylesheet" href="/stockopname/assets/css/element.css">
  <link rel="stylesheet" href="/stockopname/assets/css/output.css">
  <link rel="stylesheet" href="/stockopname/node_modules/tailwindcss/src/css/preflight.css">
...
<body>
  ...
  <script src="/stockopname/assets/dist/preline.js"></script>
  ...
  <header
    ...
    <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
      <div class="me-5 lg:me-0 lg:hidden">
        <!-- Logo -->
        <a class="flex-none rounded-md text-lg text-green-800 inline-block font-semibold focus:outline-none focus:opacity-80" href="#"
          aria-label="Preline">
         RISNA COOKIES
        </a>
        <!-- End Logo -->
 ...
 " role="dialog" tabindex="-1" aria-label="Sidebar">
    <div class="relative flex flex-col h-full max-h-full">
      <div class="px-6 pt-4">
        <!-- Logo -->
        <a class="flex-none rounded-xl text-xl inline-block font-semibold text-green-800 text-2xl focus:outline-none focus:opacity-80" href="#"
          aria-label="Preline">
          RISNA COOKIES
        </a>
        <!-- End Logo -->
            ...
            <li class="hs-accordion" id="account-accordion">
              ...
              <div id="account-accordion-child"
                ...
                <ul class="ps-8 pt-1 space-y-1">
                  <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                      href="/stockopname/pabrik">
                      Pabrik
                    </a>
                  </li>
                  <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                      href="/stockopname/produk">
                      Produk
                    </a>
                  </li>
                  <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                      href="/stockopname/toko">
                      Toko
                    </a>
                  </li>
                  <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                      href="/stockopname/bahan-baku">
                      Bahan Baku
                    </a>
                  </li>
                </ul>
            ...
            <li class="hs-accordion" id="projects-accordion">
              ...
              <div id="projects-accordion-child"
                ...
                <ul class="ps-8 pt-1 space-y-1">
                  <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                      href="/stockopname/penjualan">
                      Penjualan
                    </a>
                  </li>
                  <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                      href="/stockopname/pembayaran">
                      Pembayaran
                    </a>
                  </li>
                </ul>
